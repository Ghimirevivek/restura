  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
      ...
      <div className='py-2 flex-1 flex items-center relative'>
        <img
          src={HeroBg}
          className=' ml-auto h-420 w-full xl:w-auto xl:h-650'
          alt='hero-bg'
        />
          ...
          {heroData &&
            heroData.map((n) => (
              ...
              >
                <img
                  src={n.imageSrc}
                  className='w-20 xl:w-40 -mt-10 xl:-mt-20 '
                  alt='I1'
                />
                <p className='text-base xl:text-xl font-semibold text-textColor mt-2 xl:mt-4'>
                  {n.name}
                </p>

                <p className='text-[12px] xl:text-sm text-lighttextGray font-semibold my-1 xl:my-3'>
                  {n.decp}
                </p>
